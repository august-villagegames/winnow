...
class RepositoryChecks(unittest.TestCase):
    ...
    def test_schema_uses_the_immutable_v4_artifact_identity(self):
        self.assertEqual(
            SCHEMA["$id"],
            "https://raw.githubusercontent.com/august-villagegames/winnow/v0.2.0/references/seed.schema.json",
        )
